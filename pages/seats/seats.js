...
Page({
    ...
    onLoad: function (options) {
      var that = this;
      var movieName = "长津湖";
      var movieTimes = "今天 10月24日 11:25-14.21 国语(2D) 今天";
      that.setData({
        movieName:movieName,
    ...
    seatChange:function(e){
      ...
      var num = 0;
      if (arr[row][col] == "/images/seat_off.png"){
        ...
        arr[row][col] = "/images/seat_on.png"
        ...
        arr[row][col] = "/images/seat_off.png"
        var seat = {
        row:row1,
        col:col1
      }
